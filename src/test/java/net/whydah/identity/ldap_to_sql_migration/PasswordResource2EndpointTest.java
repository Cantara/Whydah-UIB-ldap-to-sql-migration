...
public class PasswordResource2EndpointTest {
    ...
    public void init() {
        ...
        main = new net.whydah.identity.Main(27835);
    ...
    @Test
    public void test_hasUserNameSetPassword_ok() {
        test_authenticateAndChangePasswordUsingToken_ok();
        ...
        assertEquals("true", response.body().print());
    }

    @Test
    public void test_authenticateAndChangePasswordUsingToken_ok() {
